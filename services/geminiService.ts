...
// TrueFrame and the Zen sibling file (zen photo editor/services/
...
const NO_REAL_WORLD_BRANDING = `### STEP 3B: NO REAL-WORLD BRANDING (mandatory, global)
        ...
        - This image must contain NO text, lettering, or logo of any kind at all, including "Deluxe Nail Spa"'s own name and contact details — see STEP 3's NO AI-DRAWN BRANDING clause above. The salon's branding is composited later in post-production from the real logo file, never drawn by the model.`;
