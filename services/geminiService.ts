...
const NO_REAL_WORLD_BRANDING = `### STEP 3B: NO REAL-WORLD BRANDING (mandatory, global)
        ...
        - The ONLY branding permitted anywhere in the image is "Deluxe Nail Spa"'s own name/logo and contact text described in STEP 3 above; nothing else in the frame carries any mark.`;
