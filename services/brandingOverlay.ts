/**
 * Deterministic post-production branding overlay for Deluxe Nail Spa's
 * Photo Suite — a browser/Canvas port of TrueFrame Studio's
 ...
 * "Deluxe Nail Spa" in gold script calligraphy directly onto the photo. That
 ...
 * not match the real logo. This overlay pastes the REAL logo PNG
 * (public/logo.png) pixel-for-pixel instead — never re-drawn, never
 * reinterpreted — and typesets the contact line in a real font, on top of a
 * photo the AI was told to leave clean (see the "leave clean space"
 * no-AI-branding instruction in geminiService.ts STEP 3).
 *
...
// Wide wordmark (362x105) — matches apply_branding_overlay.py's
// LOGO_WIDTH_FRACTION['deluxe-nail-spa'].
...
const BRAND_PHONE = '(919) 916-5963';
const BRAND_ADDRESS = '238 Crossroads Blvd, Cary, NC 27518';
...
/**
 * Composites the real Deluxe Nail Spa logo + contact text onto a generated
